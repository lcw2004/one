...
<head>
	...
	<script>
		...
		$(document).ready(function () {
			var actions = {queryMenu: {method: 'get', url: '${ctxRest}/sys/menu/workflow'}};
			new Vue({
                el: ".wrapper",
				data: {
					menu : {}
...
<script>
	var MainHeadUserAccount = {
		template : "#main-head-workflow-account"
	};
</script>
<template id="main-head-user-account">
	<li class="dropdown user user-menu">
		<!-- Menu Toggle Button -->
		<a href="#" class="dropdown-toggle" data-toggle="dropdown">
			<!-- workflowuser image in the navbar-->
		...
		<ul class="dropdown-menu">
			<!-- workflowuser image in the menu -->
...
<script>
	var MainAsideUserPanel = {
		template : "#main-aside-workflow-panel"
	};
</script>
