          ...
          <div class="row row-margin-bottom">
            <div class="col-md-4">
              <div class="pull-right">
                <router-link to="/msg/message/add" class="btn btn-primary">添加</router-link>
              </div>
            </div>
          </div>
        </form>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <tr v-for="(obj, index) of page.list">
                  ...
                  <td>
                    <router-link :to='"/msg/message/" + obj.messageId + "/edit"'>修改</router-link>
...
export default {
  ...
  methods: {
    deleteData (obj) {
      this.$confirm('确认删除吗？', () => {
        this.$api.msg.deleteMsgMessage(obj.messageId).then((response) => {
