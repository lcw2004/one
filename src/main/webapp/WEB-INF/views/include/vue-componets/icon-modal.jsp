...
function getIcons() {
    ...
    headers.each(function () {
        var key = $(this).text();
        var faList = $(this).parent().find(".fa");
        var iconList = new Array();
        faList.each(function () {
            iconList.push($(this).attr("class"));
        });
