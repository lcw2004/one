...
public class VueModalGenerator implements IGenerator {
    ...
    public CodeBean generateVue(TableGen table, String moduleName, Map<String, Object> params) {
        String code = iFillTemplate.fill("VueModal.vue", params);
    ...
    public String getVuePath(TableGen table, String moduleName) {
        return CodeGenUtil.getUICodeSavePath() + "views" + File.separator + moduleName + File.separator + table.getClassNameNoEO() + File.separator + table.getClassNameNoEO() + "View.vue";
    }
}
