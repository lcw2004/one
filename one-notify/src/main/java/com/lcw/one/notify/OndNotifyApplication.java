...
public class OndNotifyApplication {

    private static final Logger logger = LoggerFactory.getLogger(OndNotifyApplication.class);

    public static void main(String[] args) {
        ApplicationContext applicationContext = SpringApplication.run(OndNotifyApplication.class, args);
